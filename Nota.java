...
double pessoasNumero = Double.parseDouble(pessoas);   /* Converte a linha acima que é texto em variável (pessoas)*/
...
JOptionPane.showMessageDialog(null,"Cada pessoa receberá : " + divisão + " carros restando  : " + resto +  " carros, que retornará ao estoque");
